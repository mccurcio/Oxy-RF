...
#### Summary: Parameter Tuning (ntree + mtry) for Random Forest when Using caret Package
...
#### Train control for Cross-validation with 5 reps:
```{r control}
cache = TRUE
set.seed(1000)
...
for (i in seq(50, 500, by = 50)) {
    ...
    key <- toString(i)
    model_list[[key]] <- rf_trees  # Store models based on varying trees
}
